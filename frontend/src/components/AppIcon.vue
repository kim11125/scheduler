...
const ICONS: Record<string, string> = {
  ...
  building: '<rect x="2" y="7" width="20" height="15" rx="1"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/><line x1="12" y1="12" x2="12" y2="12"/><path d="M8 12h.01M12 12h.01M16 12h.01M8 16h.01M12 16h.01M16 16h.01"/>',
...
const iconPath = computed(() => ICONS[props.name] || ICONS['alert'])
</script>
